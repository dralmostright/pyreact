    ...
    return(
        <div className="container">
            ...
            <form>
                ...
                {errors.title?.type === "maxLength" && <p style={{color:'red'}}><small>Title should be max 25 characters</small></p>}
                <Form.Group>
                ...
                {errors.description?.type === "maxLength" && <p style={{color:'red'}}><small>Description should be max 255 characters</small></p>}
                <br />
                <Form.Group>
